...
class TaskResultSpec extends ObjectBehavior
{
    ...
    public function it_creates_passed_task(TaskInterface $task, ContextInterface $context)
    {
    ...
    public function it_creates_failed_task(TaskInterface $task, ContextInterface $context)
    {
    ...
    public function it_creates_skipped_task(TaskInterface $task, ContextInterface $context)
    {
    ...
    public function it_should_be_a_blocking_task_if_it_is_a_failed_task(TaskInterface $task, ContextInterface $context)
    {
        $this->beConstructedThrough('createFailed', [$task, $context, self::FAILED_TASK_MESSAGE]);
        $this->isBlocking()->shouldBe(true);
    }

    public function it_should_not_be_a_blocking_task_if_it_is_a_passed_task(TaskInterface $task, ContextInterface $context)
    {
        $this->beConstructedThrough('createPassed', [$task, $context, self::FAILED_TASK_MESSAGE]);
        $this->isBlocking()->shouldBe(false);
    }

    public function it_should_not_be_a_blocking_task_if_it_is_a_non_blocking_failed_task(TaskInterface $task, ContextInterface $context)
    {
