...
{
    public function let(ConsoleIO $consoleIO)
    {
    ...
    public function it_does_not_displays_the_full_process_output(Process $process)
    {
    ...
    public function it_displays_stdout_simple(Process $process)
    {
    ...
    public function it_displays_stdout_long(Process $process)
    {
    ...
    public function it_displays_stdout_special_correctly(Process $process)
    {
