...
{
    function let(GrumPHP $config, LocatorInterface $externalCommandLocator, ProcessBuilder $processBuilder)
    {
        $this->beConstructedWith($config, array(), $externalCommandLocator, $processBuilder);
    }
    ...
    {
        $externalCommandLocator->locate('codecept')->shouldBeCalled();
