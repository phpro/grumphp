...
class PhpMdSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('GrumPHP\Task\PhpMd');
    }

    function it_should_have_a_name()
    {
        $this->getName()->shouldBe('phpmd');
    }
    ...
    {
        $processBuilder->buildProcess('phpmd')->shouldNotBeCalled();
    ...
    function it_runs_the_suite(ProcessBuilder $processBuilder, Process $process, ContextInterface $context)
    {
        ...
        $processBuilder->createArgumentsForCommand('phpmd')->willReturn($arguments);
