...
class TwigCsSpec extends ObjectBehavior
{
    function let(GrumPHP $grumPHP, ProcessBuilder $processBuilder, ProcessFormatterInterface $formatter)
    {
        $grumPHP->getTaskConfiguration('twigcs')->willReturn([]);
        $this->beConstructedWith($grumPHP, $processBuilder, $formatter);
    }

    function it_is_initializable()
    {
        $this->shouldHaveType(TwigCs::class);
    }

    function it_should_have_a_name()
    {
        $this->getName()->shouldBe('twigcs');
    }
    ...
    {
        $processBuilder->createArgumentsForCommand('twigcs')->shouldNotBeCalled();
    ...
    function it_runs_the_check(ProcessBuilder $processBuilder, Process $process, ContextInterface $context)
    {
        ...
        $processBuilder->createArgumentsForCommand('twigcs')->willReturn($arguments);
        ...
        $context->getFiles()->willReturn(new FilesCollection([
            new SplFileInfo('test.twig', '.', 'test.twig')
        ]));
