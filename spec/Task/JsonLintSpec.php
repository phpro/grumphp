...
{
    public function let(GrumPHP $grumPHP, JsonLinter $linter)
    {
    ...
    public function it_does_not_do_anything_if_there_are_no_files(JsonLinter $linter, ContextInterface $context)
    {
    ...
    public function it_runs_the_suite(JsonLinter $linter, ContextInterface $context)
    {
        $linter->isInstalled()->willReturn(true);
    ...
    public function it_throws_exception_if_the_process_fails(JsonLinter $linter, ContextInterface $context)
    {
        $linter->isInstalled()->willReturn(true);
        $linter->setDetectKeyConflicts(false)->shouldBeCalled();
        $linter->lint(Argument::type('SplFileInfo'))->willReturn(new LintErrorsCollection([
